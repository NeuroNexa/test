...
protected:
  ...
  void odom_cb();
  void right_battery_cb(const sensor_msgs::msg::BatteryState::SharedPtr battery_msg);
  void left_battery_cb(const sensor_msgs::msg::BatteryState::SharedPtr battery_msg);
  ...
  rclcpp::Subscription<sensor_msgs::msg::BatteryState>::SharedPtr left_battery_info_subscription_;
  rclcpp::Subscription<sensor_msgs::msg::BatteryState>::SharedPtr right_battery_info_subscription_;
...
protected: // TODO:
  ...
  bool left_battery_flag_ = false;
  bool right_battery_flag_ = false;
  int joy_count_ = 0;
