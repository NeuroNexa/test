#ifndef TENSOR_CUDA_TEST_HPP
#define TENSOR_CUDA_TEST_HPP
...
private:
  ...
  float * buffers[3];
  size_t input_size_0 = 57  * sizeof(float);
  size_t input_size_1 = 57  * 10 * sizeof(float);
  size_t output_size = 16 * sizeof(float);
  cudaStream_t stream;
