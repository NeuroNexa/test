#ifndef RL_TENSORRT_HO_HPP
#define RL_TENSORRT_HO_HPP
...
class RLTensorRT_HO_Handle
{
public:
    RLTensorRT_HO_Handle(float* torque_set):torque_set_(torque_set), 
    ...
    {
        cuda_test_ = std::make_shared<CudaTest>("/home/robot/model_gn_m2.engine");
        std::cout << input_1.get()[569] << std::endl;
    }
    ~RLTensorRT_HO_Handle()
    {
    }
