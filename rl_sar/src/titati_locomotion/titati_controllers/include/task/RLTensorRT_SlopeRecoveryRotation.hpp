#ifndef RL_TENSORRT_SRR_HPP
#define RL_TENSORRT_SRR_HPP
...
class RLTensorRT_SRR_Handle
{
public:
    RLTensorRT_SRR_Handle(float* torque_set):torque_set_(torque_set), 
    ...
    {
        cuda_test_ = std::make_shared<CudaTest>("/home/robot/model_gn_m1.engine");
        std::cout << input_1.get()[569] << std::endl;
    }
    ~RLTensorRT_SRR_Handle()
    {
    }
