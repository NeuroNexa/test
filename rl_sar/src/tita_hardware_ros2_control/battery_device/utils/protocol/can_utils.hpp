...
#ifndef DEVICES__BATTERY_DEVICE__UTILS__PROTOCOL__CAN_UTILS_HPP_
#define DEVICES__BATTERY_DEVICE__UTILS__PROTOCOL__CAN_UTILS_HPP_
...
#endif  // DEVICES__BATTERY_DEVICE__UTILS__PROTOCOL__CAN_UTILS_HPP_
