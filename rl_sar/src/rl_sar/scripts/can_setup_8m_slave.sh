...
nohup ros2 launch rl_sar titati_bringup.launch.py role:=slave \
  > "${LOG_DIR}/titati_infrastructure_slave.log" 2>&1 &
echo "Started Titati infrastructure launch (PID $!) -> ${LOG_DIR}/titati_infrastructure_slave.log"
