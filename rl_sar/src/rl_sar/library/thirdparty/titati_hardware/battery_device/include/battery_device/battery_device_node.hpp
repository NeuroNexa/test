...
#ifndef BATTERY_DEVICE__BATTERY_DEVICE_NODE_HPP_
#define BATTERY_DEVICE__BATTERY_DEVICE_NODE_HPP_

#include <chrono>
#include <memory>
#include <string>

#include "battery_device/battery.hpp"
#include "battery_device/battery_device_node.hpp"
#include "battery_device/battery_info.hpp"
#include "battery_device/power_management.hpp"
...
private:
  ...
  rclcpp::Service<tita_system_interfaces::srv::PowerStateSetSrv>::SharedPtr power_state_set_srv_ =
    nullptr;
  rclcpp::Service<tita_system_interfaces::srv::PowerHeartBeatSrv>::SharedPtr power_heart_beat_srv_ =
    nullptr;
  rclcpp::Service<tita_system_interfaces::srv::PowerSelfTestSrv>::SharedPtr power_self_test_srv_ =
    nullptr;
...
#endif  // BATTERY_DEVICE__BATTERY_DEVICE_NODE_HPP_
