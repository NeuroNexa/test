...
#define CAN_ID_STATE 0x102
  ...
  {
  public:
    MotorsImuCanReceiveApi(size_t size, const std::string & interface = "can0")
    {
      motors_can_interface = interface;
  ...
  private:
#define MIN_TIME_OUT_US 1'000L
#define MAX_TIME_OUT_US 3'000'000L
