...
#define CAN_MASK_AS_CANFD_ROUTER_INFO (0x0FFU)
  ...
  can_device::socket_can::can_fd_callback canfd_router_can_receive_callback =
    std::bind(&CanfdRouterCanReceiveApi::get_board_can_data, this, std::placeholders::_1);

  std::shared_ptr<can_device::socket_can::CanDev> canfd_router_can_receive_api =
  ...
  std::shared_ptr<can_device::socket_can::CanDev> set_forcedirect_can_send_api =
    std::make_shared<can_device::socket_can::CanDev>(
